...
class MarketLoadStateAdapter(private val retry: () -> Unit) :
    LoadStateAdapter<MarketLoadStateAdapter.LoadStateViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, loadState: LoadState): LoadStateViewHolder {
        val binding = LoadStateLayoutBinding.inflate(
